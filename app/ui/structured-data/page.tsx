  ...
  return (
    <div className="flex flex-col w-full max-w-2xl pt-12 pb-24 mx-auto">
      ...
      <form
        ...
        className="fixed bottom-0 w-full max-w-2xl mx-auto left-0 right-0 p-4 border-t border-zinc-200 dark:border-zinc-900 shadow-lg"
      >
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 dark:bg-zinc-900 p-2 border border-zinc-700 dark:border-zinc-800 rounded-full shadow-xl"
          />
          {isLoading ? (
            <button
              type="button"
            ...
            <button
              ...
              className="bg-zinc-700 text-white px-4 py-2 rounded-full hover:bg-zinc-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
